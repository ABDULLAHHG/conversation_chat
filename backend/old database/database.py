### become in modules\database\__init__.py
...
### become modules\database\user_operations.py
...
### end of user_operations.py

### no needed for now (not used)
def show_messages():
    session = Session()
    try:
...
def show_messages()->None:
    ...
    try:
        ...
        session.close()
### end of no needed code 



### become moduls/Database/utils.py
...
### modules\database\conversation_operations.py
...
### end of conversation_operations 

### become modules\database\message_operations.py
